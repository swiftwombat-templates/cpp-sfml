...
A cross-platform [SFML](https://www.sfml-dev.org) & C++17 build environment for [Visual Studio Code](https://code.visualstudio.com/).

> Note: This template was forked from the [sfml-vscode-boilerplate](https://github.com/rewrking/sfml-vscode-boilerplate) repo created by the user [rewrking](https://github.com/rewrking). I have slightly reworked this repo to better fit my SFML/C++ setup preferences...
...
- [SFML - GCC MinGW (DW2) 32-bit (for Windows)](https://www.sfml-dev.org/download.php)
- [GCC MinGW (DW2) 32-bit (for Windows)](https://sourceforge.net/projects/mingw-w64/)
- [Git Bash (for Windows) ](https://git-scm.com/downloads)

### MacOS

- [SFML - Clang 64-bit](https://www.sfml-dev.org/download.php)
- Command Line Tools / XCode (type "xcode-select --install" in terminal to trigger the installer)

### Linux

- Get SFML from your distro if it has it, or compile from source
...
1. Download & Extract SFML to **C:/SFML/** where the bin/lib/include folders are contained within
...
2. Follow the "Installing SFML" directions here: [https://www.sfml-dev.org/tutorials/2.5/start-osx.php#installing-sfml](https://www.sfml-dev.org/tutorials/2.6/start-osx.php)

### Linux

1. Ensure the GCC Toolchain is installed (**sudo apt install build-essential**) (**sudo pacman -S base-devel**)
2. Install libsfml (**sudo apt install libsfml-dev**) (**sudo pacman -S sfml**). The SFML version you got will vary depending on the distro.
...
1. Open the **sfml** template folder in VS Code.
...
GCC is still probably the most stable GCC build on Windows, but if you want to try out newer versions, you can use [MSYS2](https://www.msys2.org/).
